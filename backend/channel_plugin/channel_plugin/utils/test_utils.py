...
def test_view(view_name, params, method="get", data=None):
    STATUS_CODES = {100:"Informational response", 200:"Success", 300:"Redirection", 400:"Client Error", 500:"Server Error"}
    ...
    for i,e in enumerate(STATUS_CODES):
        ...
        if response.status_code >= e and response.status_code < e + 100:
            data.update({ "view_name": verbose_name, "status_code":e, "type":"Endpoint Status"})
            return data
