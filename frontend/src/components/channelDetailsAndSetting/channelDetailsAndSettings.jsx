        ...
        >
          ...
          <ModalContent p={0} mt="8rem" borderRadius="2px">
            ...
            <Stack direction="row" spacing={4} align="center" color='#fff' my={3} py={2}>
                <Button color='#fff' leftIcon={<BellIcon />} rightIcon={<ChevronDownIcon />} colorScheme="whiteAlpha" variant="outline">
                    Get Notifications for @ mentions
                </Button>
                <Button color='#fff' leftIcon={<EmailIcon />} colorScheme="whiteAlpha" variant="outline">
                    Start Meeting
                </Button>
            </Stack>
            <TabsRows />
