...
const FileList = (props) => {
    const { filename, username, time} = props
    ...
    return (
            <Flex flexDirection='column'>
              ...
              <Image borderRadius="full" boxSize="36px" src="https://bit.ly/sage-adebayo" alt="Segun Adebayo"/>
                    ...
                    <Flex flexDirection='column' ml='6' >
                        <Text fontWeight='bold' fontSize='12px' color='#333333'>Image.png{filename}</Text>
                        <Flex flexDirection='row' alignItems='center' justifyContent='center'>
                            <Text fontSize='8px' mr='8px' fontWeight='bold' color='#717171'>Kevin{username}</Text>
                            <Text fontSize='8px' color='#717171'>Aug 25th at 6.30AM{time}</Text>
                        </Flex>
                    </Flex>
                </Flex>
            </Flex>
        ...
        <Box position='absolute' px={8} pt='3' rounded="sm" width='510px' height='343px' left='50px' top='473px' backgroundColor='#FFFFFF' border='1px solid #EBEBEB'>
                    ...
                    <FileList filename="Image.png" username="Kevin" time="Aug 25th at 6.30AM"/>
