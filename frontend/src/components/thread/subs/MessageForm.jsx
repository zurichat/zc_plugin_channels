        ...
        <div>
            <Stack bg="white" h="94px" display="block" maxW="350px" margin="5px" border='1px solid #EBEBEB' borderRadius="3px">
                ...
                <Container display='flex' justifyContent="space-between">
                    <Box display='flex'>
                        <Icon p='8px' pr='10px' ml='5px' borderRight='1px solid #EBEBEB' color="#8B8B8B" as={IoFlashOutline} />
                    ...
                    <Box display='flex'>
                        ...
                        <Icon style={{backgroundColor: focused ? '#00B87C' : '', color: focused ? 'white' : ''}} p='8px' mr='5px' color="#8B8B8B" as={MdSend} />
                    </Box>
                </Container>
            </Stack>
