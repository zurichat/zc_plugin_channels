    ...
    <>
      ...
      >
        ...
        <ModalContent p={2} mt="8rem" borderRadius="2px">
          <ModalHeader pb={0} fontSize="20px">
            Create a Channel
          </ModalHeader>
          <ModalCloseButton />
          <ModalBody pb={3}>
            <Text color="#8B8B8B" pb={4} fontSize="16px" pr={0}>
            ...
            <Text color="#8B8B8B" pb={8} fontSize="16px" pr={0}>
              What is this channel about?
            </Text>

            <Heading as="h5" size="sm" fontSize="16px" fontWeight="600" mt="1">
