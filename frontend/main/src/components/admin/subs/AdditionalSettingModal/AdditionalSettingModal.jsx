        ...
        <ModalBody p="0">
          ...
          <HStack fontFamily="Lato" mb="1.75rem">
            <Text fontSize="16px" color="#8B8B8B" flex="1">
              If you don’t think it will be used anymore you can archive it (All
              members will be removed ). You can retreive it later.
            </Text>
            <Switch
              id="archiveChannel"
              colorScheme="green"
              ...
              onChange={ev => setArchiveChannel(ev.target.checked)}
            />
          </HStack>
          ...
          <Text fontSize="16px" color="#8B8B8B" pb="10px" mb="1.75rem">
            you can rename your channel name anytime, but dont do it too often
          </Text>
          <Flex justifyContent="space-between" mb="1.75rem">
            <Text fontWeight="700" fontSize="16px" color="#2B2B2B">
          ...
          <Text fontSize="16px" fontWeight="bold" color="#2B2B2B">
            Delete this channel
          </Text>
          <HStack mt="10px">
            <Text
              ...
              fontFamily="Lato"
            >
              Deleting a channel will permanently remove all of its messages.
