    ...
    <Modal isOpen={isOpen} onClose={onClose} size="xl">
      ...
      <ModalContent p="40px">
        ...
        <ModalBody p="0" mt="1.9rem">
          <Text color="#8B8B8B">
            You are about to archive this Channel, all users will be removed
            from channel. However the messages and files shares will still be
            available in general search, but it will not appear in the side bar.
          </Text>
        </ModalBody>
