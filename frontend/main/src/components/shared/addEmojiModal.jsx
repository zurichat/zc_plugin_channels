        ...
        <ModalBody>
          <Box>
            <Text fontSize="15px" color="#3A3A3A">
              ...
              You’ll find it in the custom tab of the emoji picker. (Hint: it’s
              the one with the Zuri icon!)
            </Text>
            <Stack spacing={0}>
              ...
              <Text fontSize="15px" color="#8B8B8B" ps="20px">
                Square images under 128 KB and with transparent backgrounds work
                best. If your image is too large, we’ll try and resize it for
                you.
              </Text>
            </Stack>
            <HStack pt="18px">
