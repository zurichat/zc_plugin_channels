...
const MessageInput = ({channelId, org_id}) =>{
  ...
  const [orgId, setOrgId] = useState([]);
    ...
    const { isOpen:isMulimediaOpen, onOpen:onMulimediaOpen, onClose:onMulimediaClose } = useDisclosure()
    const { isOpen:isAddEmojiOpen, onOpen:onAddEmojiOpen, onClose:onAddEmojiClose } = useDisclosure()
