    ...
    <Popover initialFocusRef={initialRef}>
      ...
      <PopoverContent>
        <PopoverBody
          ...
          borderRadius="3px"
          bg="white"
          boxShadow="0 6px 30px 0 #a5a5a540"
        >
          <VStack
            px="15px"
            py="17px"
...
const PinMessageCard = ({
  ...
  return (
    <Flex
      ...
      ref={msgRef}
      bg="#FFFFFF"
      shadow="0 6px 30px 0 #A5A5A526"
      border="1px solid #E7E7E733"
      _focus={{ bg: "#F1FFFA" }}
      _hover={{ bg: "#F1FFFA" }}
    >
      <Box>
        <Avatar name={userId} src={icon} w="25px" h="25px" borderRadius="4px" />
      </Box>
      <VStack>
        <HStack>
          <Text fontWeight="900" color="#1D1C1D">
            {userId}
          </Text>
