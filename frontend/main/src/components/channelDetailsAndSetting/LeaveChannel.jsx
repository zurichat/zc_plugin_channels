...
function LeaveChannel() {
  ...
  return (
    <>
      <Button color="red" fontSize="xs" variant="link" onClick={onOpen}>
        Leave Channel
      </Button>
      ...
      <Modal isOpen={isOpen} onClose={onClose} colorScheme="none">
        ...
        >
          ...
          <ModalBody p="0" mt="20px">
            <Text color="#616061" fontSize="18px" maxW="528px" mb="0.5">
              {" "}
            ...
            >
              <Box mt="20px" alignItems="center" display="flex">
                <Checkbox
                  ...
                  isInvalid
                />
                <Text m="0" ml="13px" fontSize="18px" color="#8B8B8B">
